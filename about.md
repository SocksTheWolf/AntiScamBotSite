...
Unfortunately, unless they are banned in all relative servers, they'll hop onto the next server and then attempt to scam people from there next.
...
<strong>I do not want to have you deal with a case where someone is banned due to drama or disagreements. With {{ site.bot_name }} you won't need to worry.</strong>
</div>
